# Outreach drafts — send from whichever address you prefer

These four are short on purpose: people in this space get long manifestos daily.
The record speaks; the email just points. Feel free to Frenchify the Breyer one
or send it in English — his office works in both.

---

## 1. EDRi — brussels@edri.org (or via edri.org/about/contact)

**Subject: A public, daily archive of who scans under the Chat Control derogation**

Hello,

I run ScanRecords (https://scanrecords.org), a public archive that answers one
question with primary sources: which providers scan under the ePrivacy
...
## 2. CDT Europe — via cdt.org/contact (or the Brussels office address on their site)

**Subject: Primary-source tracker for voluntary scanning under Regulation 2021/1232**
...
All data is CC0 (https://scanrecords.org/data/), methodology and corrections
policy are public, and companies can dispute statuses openly.

If useful for your monitoring, it's yours to build on.
...
## 3. Patrick Breyer's office — via patrick-breyer.de contact form

**Subject: ScanRecords — your Chat Control service list, now under daily archival**
...
COM(2025) 740 — both facts are shown side by side on their pages.

Data is CC0; corrections are public. Thank you for the years of tracking that
made the statuses verifiable at all.
...
## 4. fightchatcontrol.eu maintainers — via the contact on their site / GitHub

**Subject: A daily evidence archive to link beside your campaign**

Hi,

fightchatcontrol.eu covers the fight; I've built the evidence shelf:
...
https://scanrecords.org/badge/signal.svg

No tracking, no cookies, no money involved. Just the record.
